...
if("TRUE" STREQUAL "TRUE")
  set(franka_msgs_SOURCE_PREFIX /home/heap/ws_franka/src/franka_ros/franka_msgs)
  set(franka_msgs_DEVEL_PREFIX /home/heap/ws_franka/devel)
  ...
  set(franka_msgs_INSTALL_PREFIX /home/heap/ws_franka/install)
...
if(NOT "/home/heap/ws_franka/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/heap/ws_franka/src/franka_ros/franka_msgs/${idir}'.  ${_report}")
    endif()
