...
if("TRUE" STREQUAL "TRUE")
  set(franka_gripper_SOURCE_PREFIX /home/heap/ws_franka/src/franka_ros/franka_gripper)
  set(franka_gripper_DEVEL_PREFIX /home/heap/ws_franka/devel)
  ...
  set(franka_gripper_INSTALL_PREFIX /home/heap/ws_franka/install)
...
if(NOT "/home/heap/ws_franka/devel/include;/home/heap/ws_franka/src/franka_ros/franka_gripper/include;/home/heap/libfranka/include " STREQUAL " ")
  set(franka_gripper_INCLUDE_DIRS "")
  set(_include_dirs "/home/heap/ws_franka/devel/include;/home/heap/ws_franka/src/franka_ros/franka_gripper/include;/home/heap/libfranka/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_gripper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/heap/ws_franka/src/franka_ros/franka_gripper/${idir}'.  ${_report}")
    endif()
    _list_append_unique(franka_gripper_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "franka_gripper;/home/heap/libfranka/build/libfranka.so.0.9.2")
